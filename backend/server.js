...
const openai = new OpenAI({
  apiKey:
    ...
    "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",
});
...
app.get("/pharmacy/prescriptions/:id", auth, async (req, res) => {
  try {
    ...
    if (prescription.deliveryDetails.pharmacy !== req.user.pharmacyId) {
      return res
        .status(403)
