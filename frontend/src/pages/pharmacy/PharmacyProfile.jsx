...
const PharmacyProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData((prev) => ({
        ...prev,
        pharmacyName: response.data.pharmacy.pharmacyName,
        email: response.data.pharmacy.email,
        address: response.data.pharmacy.address,
        contact: response.data.pharmacy.contact,
        password: "",
        confirmPassword: "",
      }));
    } catch (error) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 px-4 py-2 border rounded-md focus:ring-2 focus:ring-[#F26522] outline-none"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className="w-full bg-gray-100 text-gray-500 px-4 py-2 border rounded-md cursor-not-allowed"
                  />
                </div>
